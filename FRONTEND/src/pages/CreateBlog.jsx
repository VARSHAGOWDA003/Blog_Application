...
const CreateBlog = () => {
    ...
    const postBlog = async (val) => {
       const response =  await axiosInstance.post("/blog/secure/create",val) // val- complete deatils of form 
  ...
  return (
    <section className='w-full max-w-[1200px] mx-auto p-2 font-outfit'>
        ...
        validationSchema={blogSchema} // it is present in formikvalidation.js
              ...
              <Form>
                ...
                <div className="mt-9 flex justify-center items-center">
                  <button type="submit" className="bg-orange-600 text-white p-3 rounded-2xl w-[90%] cursor-pointer flex justify-center items-center">
                    ...
                    {
                        postBlogMutation.isLoading && <Loader/>// mutation  is loading , lazyloading
                    }
