...
const BlogPage = () => {
  ...
  const fetchBlog = async () => {
    const response = await axiosInstance.get(`/blog/public/${BLOG_ID}`); // blog id as the path variable
    return response.data;
  };
  ...
  const {
    ...
    isError: blogError, // if any error is present 
  } = useQuery({ // fetchblog will be invoked 
