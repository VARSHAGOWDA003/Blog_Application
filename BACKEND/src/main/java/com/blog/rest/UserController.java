...
public class UserController {
			...
			@PathVariable Integer id)
	{
		...
		userDTO.setPassword(null);//SHOULD not exposed so null
		userDTO.setBlogsCount(findUser.getBlogs().size()); //no of elements in the list 
		userDTO.setImg(findUser.getProfileImgUrl());
		
		return ResponseEntity.ok(new ApiResponse<>("success","Profile Data", userDTO)); //response sent back to frontend 
